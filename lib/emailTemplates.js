  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f4f4f0;padding:32px 12px">
    <tr><td align="center">
      <table role="presentation" width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:22px;overflow:hidden;max-width:520px;width:100%;border:1px solid #ececE4">
        ...
        <tr><td bgcolor="#0a0a0a" class="rd-hero" style="background:#0a0a0a;padding:36px 34px 38px">
          <img src="${LOGO_URL}" width="52" height="52" alt="Ruedda" style="border-radius:12px;display:block;margin-bottom:28px;border:1px solid #2a2a2a">
        ...
        <tr><td style="padding:26px 34px 32px">
          ...
          <div style="font-size:11.5px;color:#999;line-height:1.6">Recibes este correo porque tienes una cuenta en Ruedda.<br>Ruedda — la app automotriz de Venezuela · contactoruedda@gmail.com</div>
        </td></tr>
